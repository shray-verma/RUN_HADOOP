...
PATH="/root/Desktop/RUN_HADOOP/HADOOP1/"

n,_=commands.getstatusoutput("rpm -q nmap")
if n != 0:
  	os.system("rpm -ivh "+PATH+"nmap-ncat-6.40-7.el7.x86_64.rpm")
        os.system("rpm -ivh "+PATH+"nmap-6.40-7.el7.x86_64.rpm")

ip_list,ip=IP_LIST.GET_IP()
ip_list.remove(str(ip))

namenode=ip_list[0]
jobtracker=ip_list[1]
datanode=[]
...
if  s  != 0 :
	commands.getoutput("rpm -ivh "+PATH+" sshpass-1.05-5.el7.x86_64.rpm")
